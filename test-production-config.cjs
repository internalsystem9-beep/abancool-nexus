...
async function testRedisConnection() {
  ...
  try {
    ...
    try {
      ...
      logTest('Redis Connection', 'warn', 'Redis not available (optional)', connectError.message);
    }
...
async function runAllTests() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║   ABANCOOL PRODUCTION CONFIGURATION TEST SUITE              ║');
  console.log('║   Testing Database, Email, and SMS Integration              ║');
  console.log('╚════════════════════════════════════════════════════════════╝');
